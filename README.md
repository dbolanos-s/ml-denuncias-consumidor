...
## 📌 Descripción
Análisis de **33,052 denuncias reales** de consumidores registradas en 2019 y 2020.
...
## 🚀 Cómo ejecutar
```bash
git clone https://github.com/dbolanos-s/ml-denuncias-consumidor
cd ml-denuncias-consumidor
jupyter notebook
```
